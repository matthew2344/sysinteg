                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="product-row__status__actions flex-grid" style="position:relative;z-index:var(--z-index-above-overlay);gap:var(--spacer-3)">
                            <a href="<?=site_url("admin/view_event/$result->eventID")?>" class="button" type="button" title="View this event">View</a>
                            <a href="<?=site_url("admin/delete_event/$result->eventID")?>" class="button danger" type="button" title="Delete this event">Delete</a>
                        </div>
                    </td>
                </tr>
                <?php endforeach;?>
