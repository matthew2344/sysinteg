...
<main class="squished">
    ...
    <?php endif;?>
        <?=form_open_multipart(site_url("admin/update_event/$result->eventID"), array('id' => 'formID'))?>
        <div class="container">
        <div class="row mb-4">
        ...
        <button formaction="<?=site_url("admin/approve_event/$result->eventID")?>" class="form-control success mt-4">Approve Event</button>
        <button type="submit" class="form-control danger mt-4">Reject Event</button>
...
previewButton.addEventListener('click', () => {
    myForm.action = "<?=site_url("admin/update_event/$result->eventID/xfgds")?>";
    myForm.submit();
})
