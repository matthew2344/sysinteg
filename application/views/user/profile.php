<header class="sticky">
    ...
    <div class="" role="tablist">
        <a href="<?=site_url("user/profile")?>" role="tab" <?php if(isset($profile_page)) echo 'aria-selected="true"'?>>
            Profile
        </a>
        <a href="<?=site_url("user/change_password")?>" role="tab" <?php if(isset($change_pass)) echo 'aria-selected="true"'?>>
            Password
        </a>
        <a href="<?=site_url("user/change_email")?>" role="tab" <?php if(isset($change_email)) echo 'aria-selected="true"'?>>
            Email
        </a>
    </div>
</header>
...
<main class="">
    ...
    <?=form_open_multipart(site_url("user/update_profile"))?>
...
<main class="">
    ...
    <?=form_open_multipart(site_url("user/update_password"))?>
        <section>
...
<main class="">
    ...
    <?=form_open_multipart(site_url("user/update_email"))?>
    <section>
